...
mvn "-Dexec.args=-Dhazelcast.phone.home.enabled=false -classpath %classpath com.hazelcast.samples.jet.faulttolerance.FaultTolerance" -Dexec.executable=java org.codehaus.mojo:exec-maven-plugin:1.6.0:exec 2>&1 | tee ${OUTPUT_LOG_FILE} &
sleep 60
