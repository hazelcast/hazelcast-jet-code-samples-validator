...
mvn "-Dexec.args=-classpath %classpath com.hazelcast.samples.jet.jdbc.JdbcSource" -Dexec.executable=java org.codehaus.mojo:exec-maven-plugin:1.6.0:exec | tee ${OUTPUT_LOG_FILE}
