...
### execute code sample ###
###########################
cd ${CODE_SAMPLES_HOME}/jet/co-group
mvn "-Dexec.args=-Dhazelcast.phone.home.enabled=false -classpath %classpath com.hazelcast.samples.jet.cogroup.WindowedCoGroup" -Dexec.executable=java org.codehaus.mojo:exec-maven-plugin:1.6.0:exec | tee ${OUTPUT_LOG_FILE}
