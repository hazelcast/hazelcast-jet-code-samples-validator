...
mvn "-Dexec.args=-classpath %classpath com.hazelcast.jet.examples.kafka.avro.KafkaAvroSource" -Dexec.executable=java org.codehaus.mojo:exec-maven-plugin:1.6.0:exec | tee ${OUTPUT_LOG_FILE}
